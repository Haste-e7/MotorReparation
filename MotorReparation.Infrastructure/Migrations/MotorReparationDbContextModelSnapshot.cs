...
{
    [DbContext(typeof(MotorReparationDbContext))]
    partial class MotorReparationDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotorReparation.Domain.LaborUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LaborUnits", (string)null);
                });

            modelBuilder.Entity("MotorReparation.Domain.PartUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PartUnits", (string)null);
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MotorReparation.Domain.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MotorReparation.Domain.Basket", b =>
                {
                    b.HasOne("MotorReparation.Domain.AppUser", "Customer")
                        .WithOne("Basket")
                        .HasForeignKey("MotorReparation.Domain.Basket", "CustomerId");
            ...
            modelBuilder.Entity("MotorReparation.Domain.LaborUnit", b =>
                {
                    b.HasOne("MotorReparation.Domain.AppUser", "Employee")
                        .WithMany()
